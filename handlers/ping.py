...
@Client.on_message(command(["بنك", "repo", "anon", "فحص"]) & filters.group & ~filters.edited & ~filters.private)
            ...
            [
                [
                    InlineKeyboardButton(
                        "ابلاغ عن مشكله", url=f"https://t.me/{SUPPORT_GROUP}"
                    ),
                    InlineKeyboardButton(
                        "السورس", url="https://github.com/Anes010/Anesmusic"
                    )
                ]
            ]
        ),
